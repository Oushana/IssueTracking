        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul id="projectList" class="nav navbar-nav">
                    ...
                    <li><button type="button" id="issues_list" class="btn btn-default navbar-btn" style="margin-left:30px">Issues</button></li>
                    <li><button type="button" id="add_issue" class="btn btn-default navbar-btn">Add Issue</button></li>

                    <li><button type="button" id="projects_list" class="btn btn-default navbar-btn" style="margin-left:30px">Projects</button></li>
